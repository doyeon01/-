package com.ssafy.handam.user.common.error;

import com.ssafy.handam.user.presentation.api.ApiUtils;
...
import static com.ssafy.handam.user.presentation.api.ApiUtils.error;
